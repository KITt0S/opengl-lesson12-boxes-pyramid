...
{
	{0.5, 0.0f, 0.0f}, {0.5, 0.25f, 0.0f}, {0.5, 0.5f, 0.0f}, {0.0, 0.5f, 0.0f}, {0.0f, 0.5f, 0.5f}
};
...
GLvoid ReSizeGLScene(GLsizei width, GLsizei height)		// Resize GL scene
{
